...
author:
  ...
  - name: '</br></br><font size="+4">A.G. Rossberg,</font>'
    main: false
    affil: 1
  - name: '<font size="+4">L. Chittka and</font>'
    main: false
    affil: 1
  - name: '<font size="+4">R.P. Thorpe.</font>'
    main: false
    affil: 2
affiliation:
  - num: 1
...
logoleft_name: '![](https://raw.githubusercontent.com/ThomasDelSantoONeill/SBCSposter/blob/main/Poster_files/QMlogo.svg){.main-img-left}'
output: 
...
link-citations: true
primary_colour: "#33CCCC"
secondary_colour: "#003399"
---
...
To reference a citation you can add your `.bib` file to the working directory and name it in the YAML metadata or generate an automated one as done here, then you only need to reference the label value in the `.bib` file. For example this package is built on top of the wonderful {pagedown} package and I will cite it at the end of this sentance using this in the rmd `-pagedown]` [-pagedown].
...
Here you may have some figures to show off, bellow I have made a scatterplot with the infamous Iris dataset and I can even reference to the figure automatically like this, `Figure \f(fig:irisfigure)`, Figure ref(fig:irisfigure).
